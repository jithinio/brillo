...
export default function OnHoldProjectsPage() {
  ...
  // Calculate metrics for on hold projects
  ...
  return (
    <div className="h-full flex flex-col">
      <PageHeader title="On Hold Projects" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 w-full mb-6">
          <div className="rounded-lg border bg-transparent text-card-foreground p-3 h-16 flex items-center">
            <div className="flex items-center gap-2 w-full">
              <h3 className="text-xs font-medium text-muted-foreground leading-none whitespace-nowrap">On Hold Projects</h3>
              <div className="text-lg font-semibold text-yellow-600 ml-auto">{metrics.totalProjects}</div>
            </div>
          </div>
          <div className="rounded-lg border bg-transparent text-card-foreground p-3 h-16 flex items-center">
            <div className="flex items-center gap-2 w-full">

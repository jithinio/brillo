...
function FinalDataTable({
  ...
  }, [projects.length, hasNextPage, isLoading, isFetchingNextPage, loadMore])
                  ...
                  <ContextMenu key={project.id}>
                    <ContextMenuTrigger asChild>
                      <motion.div
                        ...
                        data-last-row={index === projects.length - 1 ? 'true' : undefined}
                      >
                        {columns.map((column: any, colIndex: number) => (
                          <div
...
function FinalProjectsContent() {
  ...
  }, [updateStatus, refetch, columnWidths])
  ...
  // Create column metadata for the view filter

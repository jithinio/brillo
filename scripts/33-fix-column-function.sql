-- Quick fix for the column ambiguity error
-- This replaces the problematic function with a corrected version

-- Fix the column checking function by using different parameter names
...
-- Also fix the validation function to be more robust
...
-- Test the fix
SELECT 'Column function fixed!' as status;
